...
const liquibase = new commander_1.Command("liquibase")
    ...
    if (data.schema)
        console.log(chalk_1.default.cyan(`   Schema: ${data.schema}`));
    console.log(chalk_1.default.yellow(`   Entidades con cambios:`));
